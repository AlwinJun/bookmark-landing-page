...
export default function Footer() {
  return (
    <section className="bg-dark-blue">
      <div className="footer p-8 sm:flex sm:items-center sm:justify-between">
        <div className="flex flex-col place-items-center gap-8 sm:flex-row sm:items-center">
          <a href="#top">
          ...
          <ul className="flex flex-col gap-6 text-base text-slate-200 sm:flex-row sm:items-center">
            {[
        ...
        <div className="mt-8 flex items-center justify-center gap-8 sm:mt-0">
          <a href="#" className="group">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              className="fill-white hover:fill-soft-red"
            >
              <path
                // fill="#FFF"
                fill-rule="evenodd"
